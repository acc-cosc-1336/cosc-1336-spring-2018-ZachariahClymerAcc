...
class Invoice:
    ...
    def print_invoice(self):
        ...
        #total cost * discount
        tcxcd = total_cost * self.customer.discount
        #total cost - discounted price
        tcxcd2 = total_cost - tcxcd
        ...
        print('Discount:   ', ' ' , format(self.customer.discount, '.2f'))
        print('total cost * customer discount', ' ' , format(tcxcd, '.2f')) 
        #ASSIGNMENT 11: modify the statement below to display total cost less total cost times customer discount
        print('total cost - discounted price: ', ' ' ,format(tcxcd2, '.2f'))
        print()
